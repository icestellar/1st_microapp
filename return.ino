/*
   CÓDIGO QUE ESTÁ FUNCIONANDO NO ESP32 :3
...
void loop() {
  if (deviceConnected) {
    // Fabricate some arbitrary junk for now...
     ...
     float rain_value = (analogRead(rain_pin)/4);
     ...
     if(rain_value> 800 && rain_value<1024){
      digitalWrite(25,LOW);
    }
    if(rain_value> 0 && rain_value<800 || newValues.temperature>39){
    ...
    sprintf(SendDataString,"%2.f,%2.f,%d,%.2f", newValues.temperature, newValues.humidity,isDetected,100-rain_value*0.097);
